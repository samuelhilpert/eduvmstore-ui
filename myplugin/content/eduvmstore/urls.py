...
urlpatterns = [
    ...
    path('create/', views.CreateView.as_view(), name='create_empty'),
    path('create/<str:template_id>/', views.CreateView.as_view(), name='create_with_template'),
    ...
    path('clone/', views.CloneView.as_view(), name='clone_empty'),
    path('clone/<str:template_id>/', views.CloneView.as_view(), name='clone'),
